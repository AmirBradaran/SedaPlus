  ...
  return (
    <CacheProvider value={cacheRtl}>
      <ThemeProvider theme={theme}>
        <Container maxWidth="lg" sx={{ py: 4, background: 'linear-gradient(135deg, var(--forth-color) 50% , var(--second-color) 60%)', borderRadius: 4, boxShadow: 4, padding: 3 , my:2.5 }}>
            ...
            {cards.map((card) => (
              <Grid item key={card.id} xs={12} sm={6} md={4}>
                <Card sx={{ 
                  ...
                  <CardContent sx={{ flexGrow: 1, textAlign: 'right', background: '#fff', borderRadius: '0 0 4px 4px' }}>
                    <Typography gutterBottom variant="h6" component="div" color="secondary" sx={{fontSize:"1.5rem" , fontWeight:"bolder"}}>
                      {card.title}
                    </Typography>
                    <Typography variant="body2" color="text.secondary" sx={{ mb: 2 , fontSize:"1.15rem" , fontWeight:"bold"}}>
                      {card.description}
                    </Typography>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      <Typography variant="h6" color="primary" sx={{fontSize:"1.25rem" , fontWeight:"bolder"}}>
                  ...
                  <CardActions sx={{ justifyContent: 'space-between', px: 2, pb: 2 }}>
                    ...
                    <Button 
                      ...
                      sx={{ borderRadius: 20, backgroundColor: '#ff4081', '&:hover': { backgroundColor: '#e91e63' } }}
                    >
                      افزودن به سبد خرید
                    </Button>
                  </CardActions>
